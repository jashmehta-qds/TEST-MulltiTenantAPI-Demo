...
namespace JWT.Controllers
{
    ...
    public class TokenController : Controller
    {
        ...
        private readonly MasterGenericService<UserViewModel, User> _userService;

        public TokenController(IConfiguration config, UserService<UserViewModel, User> userService)
        {
            _config = config;
